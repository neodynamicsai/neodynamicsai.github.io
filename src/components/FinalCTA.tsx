        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-card border border-primary/30 p-8 md:p-16 text-left md:text-center space-y-8">
          ...
          <div className="relative z-10 space-y-6">
            <h2 className="text-4xl md:text-5xl font-bold leading-tight">
              Turn the inevitable breach into a <br className="hidden md:block" />{" "}
              <span className="text-gradient">dead end.</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Book a 1-hour assessment and see the paths to your crown jewels — plus the smallest changes that stop lateral movement.
            </p>
